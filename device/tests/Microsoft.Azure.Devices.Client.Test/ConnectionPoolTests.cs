...
namespace Microsoft.Azure.Devices.Client.Test
{
    ...
    public class ConnectionPoolTests
    {
        ...
        public async Task HubScopeMuxConnection_ConnectionIdleTimeoutTest()
        {
            ...
            await singleConnection.CreateSendingLinkAsync("test", iotHubConnectionString, "device", IotHubConnection.SendingLinkType.Telemetry, TimeSpan.FromMinutes(2), CancellationToken.None);
        }
