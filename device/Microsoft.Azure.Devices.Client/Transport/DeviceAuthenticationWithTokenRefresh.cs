...
namespace Microsoft.Azure.Devices.Client
{
    ...
    /// </summary>
    public sealed class DeviceAuthenticationWithTokenRefresh : IAuthenticationMethod
    {
        string deviceId;
        string token;
        ...
        public DeviceAuthenticationWithTokenRefresh(string deviceId, string token)
        {
