...
namespace Microsoft.Azure.Devices.Provisioning.Client.Transport
{
    ...
    internal class ProvisioningChannelHandlerAdapter : ChannelHandlerAdapter
    {
        ...
        private async Task PublishRegisterAsync(IChannelHandlerContext context)
        {
            ...
            if ((_message.Payload != null && _message.Payload.Length > 0) || !string.IsNullOrEmpty(_message.CertificateSigningRequest))
            {
                ...
                if (!string.IsNullOrEmpty(_message.CertificateSigningRequest))
                {
                    deviceRegistration.Csr = _message.CertificateSigningRequest;
                }
