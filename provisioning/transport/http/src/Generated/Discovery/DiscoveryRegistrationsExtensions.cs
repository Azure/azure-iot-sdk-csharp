...
namespace Microsoft.Azure.Devices.Discovery.Client.Transport.Http
{
    ...
    public static partial class DiscoveryRegistrationsExtensions
    {
            ...
            /// </param>
            public static async Task<BootstrapResponse> GetOnboardingInfoAsync(this IDiscoveryRegistrations operations, string apiVersion, BootstrapRequest body, CancellationToken cancellationToken = default(CancellationToken))
            {
                using (var _result = await operations.GetOnboardingInfoWithHttpMessagesAsync(apiVersion, body, null, cancellationToken).ConfigureAwait(false))
                {
                    return _result.Body;
                }
            }
