...
namespace Microsoft.Azure.Devices.Provisioning.Client.Transport.Models
{
    ...
    /// </summary>
    public partial class ReprovisionAcceptedResponse
    {
        /// <summary>
        /// Initializes a new instance of the ReprovisionAcceptedResponse
        /// class.
        /// </summary>
        public ReprovisionAcceptedResponse()
        {
            CustomInit();
        }
        ...
        public ReprovisionAcceptedResponse(string id, string status, AzureCoreFoundationsError error = default(AzureCoreFoundationsError), Device result = default(Device))
        {
            Id = id;
            Status = status;
            Error = error;
