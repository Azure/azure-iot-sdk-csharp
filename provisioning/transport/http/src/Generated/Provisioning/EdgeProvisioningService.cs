...
namespace Microsoft.Azure.Devices.Provisioning.Client.Transport
{
    ...
    public partial class EdgeProvisioningService : ServiceClient<EdgeProvisioningService>, IEdgeProvisioningService
    {
        ...
        private void Initialize()
        {
            ...
            SerializationSettings.Converters.Add(new PolymorphicSerializeJsonConverter<ResponseMetadata>("kind"));
            DeserializationSettings.Converters.Add(new  PolymorphicDeserializeJsonConverter<ResponseMetadata>("kind"));
            SerializationSettings.Converters.Add(new PolymorphicSerializeJsonConverter<ResourceMetadata>("kind"));
            DeserializationSettings.Converters.Add(new  PolymorphicDeserializeJsonConverter<ResourceMetadata>("kind"));
            CustomInitialize();
        }
    }
}
