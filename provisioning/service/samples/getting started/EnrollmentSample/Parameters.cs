...
namespace Microsoft.Azure.Devices.Provisioning.Service.Samples
{
    internal class Parameters
    {
        ...
        [Option(
            "NamespaceName",
            Required = false,
            HelpText = "Optional. The namespace name (3-64 chars) to associate with the enrollment. Available starting with service API version 2026-11-01; only sent when a 2026 API version is selected.")]
        public string NamespaceName { get; set; }

        [Option(
            "CertificateAuthorityName",
            Required = false,
            HelpText = "Optional. The certificate authority name (3-63 chars) to associate with the enrollment. Available starting with service API version 2026-11-01; only sent when a 2026 API version is selected.")]
        public string CertificateAuthorityName { get; set; }

        [Option(
            "CertificatePolicyName",
            Required = false,
            HelpText = "Optional. The certificate policy name (3-63 chars) to associate with the enrollment. Available starting with service API version 2026-11-01; only sent when a 2026 API version is selected.")]
