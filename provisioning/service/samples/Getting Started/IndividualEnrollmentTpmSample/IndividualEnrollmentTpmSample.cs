...
namespace Microsoft.Azure.Devices.Provisioning.Service.Samples
{
    internal class IndividualEnrollmentTpmSample
    {
        ...
        private readonly ProvisioningClientCapabilities _optionalEdgeCapabilityEnabled = new() { IsIotEdge = true };
        private readonly ProvisioningClientCapabilities _optionalEdgeCapabilityDisabled = new() { IsIotEdge = false };

        private readonly ProvisioningServiceClient _provisioningServiceClient;

        public IndividualEnrollmentTpmSample(ProvisioningServiceClient provisioningServiceClient, string deviceId, string registrationId, string tpmEndorsementKey)
        {
