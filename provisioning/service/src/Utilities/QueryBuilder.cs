...
namespace Microsoft.Azure.Devices.Provisioning.Service
{
    internal class QueryBuilder
    {
        ...
        internal static async Task<Page<T>> BuildAndSendRequestAsync<T>(IContractApiHttp contractApiHttp, RetryHandler retryHandler, string query, Uri path, string continuationToken, int? pageSizeHint, CancellationToken cancellationToken)
        {
