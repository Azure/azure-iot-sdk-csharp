...
namespace Microsoft.Azure.Devices.Provisioning.Service
{
    ...
    public class DeviceRegistrationState
    {
        ...
        /// </summary>
        /// <remarks>
        /// Known values are <c>classic</c> and <c>mqttV5</c>; other values may be returned by the service in the
        /// future and are surfaced as-is. When the service does not emit this value it is <c>null</c>, which is
        /// semantically equivalent to <c>classic</c>.
        /// </remarks>
