...
namespace Microsoft.Azure.Devices.Provisioning.Service
{
    ...
    public class IndividualEnrollmentsClient
    {
        ...
        public async Task<IndividualEnrollment> CreateOrUpdateAsync(IndividualEnrollment individualEnrollment, CancellationToken cancellationToken = default)
        {
                    ...
                    async () =>
                    {
                        contractApiResponse = await _contractApiHttp
                            .RequestAsync(
                                ...
                                null,
                                JsonSerializer.Serialize(individualEnrollment),
            ...
            return JsonSerializer.Deserialize<IndividualEnrollment>(contractApiResponse.Body);
        }
            ...
            CancellationToken cancellationToken = default)
        {
            ...
            return JsonSerializer.Deserialize<BulkEnrollmentOperationResult>(contractApiResponse.Body);
        }
        ...
        public async Task<AttestationMechanism> GetAttestationAsync(string registrationId, CancellationToken cancellationToken = default)
        {
            ...
            return JsonSerializer.Deserialize<AttestationMechanism>(contractApiResponse.Body);
        }
