...
namespace Microsoft.Azure.Devices.Provisioning.Service
{
    ...
    /// A base retry policy.
    /// </summary>
    public abstract class ProvisioningServiceRetryPolicyBase : IProvisioningServiceRetryPolicy
    {
        ...
        protected ProvisioningServiceRetryPolicyBase(uint maxRetries)
        {
        ...
        public virtual bool ShouldRetry(uint currentRetryCount, Exception lastException, out TimeSpan retryDelay)
        {
            ...
            return (lastException is ProvisioningServiceException ex
                    && ex.IsTransient)
                && (MaxRetries == 0
