...
namespace Microsoft.Azure.Devices.Provisioning.Service
{
    ...
    public class ReprovisionPolicy
    {
        ...
        /// </summary>
        [JsonProperty("updateHubAssignment", DefaultValueHandling = DefaultValueHandling.Include)]
        public bool UpdateHubAssignment { get; set; }

        /// <summary>
        /// When set to true (default), the Device Provisioning Service will migrate the device's data
        /// (twin, device capabilities, and device Id) from one IoT hub to another during an IoT hub assignment update.
        ...
        /// </summary>
        [JsonProperty("migrateDeviceData", DefaultValueHandling = DefaultValueHandling.Include)]
