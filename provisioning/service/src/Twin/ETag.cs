...
namespace Microsoft.Azure.Devices.Provisioning.Service
{
    ...
    /// </summary>
    /// <remarks>
    /// This is a copy of the same class defined in Azure.Core, but with a slightly
    /// different JsonConverter tag since this library serializes ETags to go in payload 
    /// objects, not headers.
    /// </remarks>
