...
namespace Microsoft.Azure.Devices.Provisioning.Service.Tests
{
    [TestClass]
    [TestCategory("Unit")]
    public class ProvisioningServiceRetryPolicyBaseTests
    {
        [TestMethod]
        public void RetryPolicyBase_ObservesMax()
        {
            ...
            var retryPolicy = new ProvisioningServiceTestRetryPolicy(maxRetries);
            var ex = new ProvisioningServiceException("", true);
        ...
        {
            // arrange
            var retryPolicy = new ProvisioningServiceTestRetryPolicy(0);
            var ex = new ProvisioningServiceException("", true);
        ...
        public void RetryPolicyBase_ProvisioningClientException_ReturnsTrueWhenTransient(bool isTransient)
        {
            // arrange
            var retryPolicy = new ProvisioningServiceTestRetryPolicy(0);
            var ex = new ProvisioningServiceException("", isTransient);
