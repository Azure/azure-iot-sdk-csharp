...
namespace Microsoft.Azure.Devices.Provisioning.Service.Tests
{
    [TestClass]
    [TestCategory("Unit")]
    public class InitialTwinPropertyCollectionTests
    {
        ...
        [TestMethod]
        public void TestInitialTwinPropertyCollectionTypeCastingAndDeserialization()
        {
            InitialTwinPropertyCollection collection = new()
            {
                Properties = new JsonDictionary()
                {
