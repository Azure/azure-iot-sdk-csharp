...
namespace Microsoft.Azure.Devices.E2ETests.Twins
{
    ...
    public class TwinFaultInjectionTests : E2EMsTestBase
    {
        ...
        public async Task Twin_DeviceReportedProperties_ConnectionLossRecovery_MqttWs()
        {
        ...
        [TestMethod]
        [TestCategory("FaultInjectionBVT")]
        public async Task Twin_DeviceReportedProperties_GracefulShutdownRecovery_MqttWs()
        {
            // Setting up one cancellation token for the complete test flow
            using var cts = new CancellationTokenSource(s_testTimeout);
            await Twin_DeviceReportedPropertiesRecoveryAsync(
        ...
        public async Task Twin_DeviceReportedProperties_ConnectionLossRecovery_Mqtt(string faultType, string faultReason)
        {
            // Setting up one cancellation token for the complete test flow
            using var cts = new CancellationTokenSource(s_testTimeout);
            await Twin_DeviceReportedPropertiesRecoveryAsync(
        ...
        [TestMethod]
        [TestCategory("FaultInjectionBVT")]
        public async Task Twin_DeviceReportedProperties_ConnectionLossRecovery_AmqpWs()
        {
            // Setting up one cancellation token for the complete test flow
            using var cts = new CancellationTokenSource(s_testTimeout);
            await Twin_DeviceReportedPropertiesRecoveryAsync(
        ...
        [TestMethod]
        [TestCategory("FaultInjectionBVT")]
        public async Task Twin_DeviceReportedProperties_GracefulShutdownRecovery_AmqpWs()
        {
            // Setting up one cancellation token for the complete test flow
            using var cts = new CancellationTokenSource(s_testTimeout);
            await Twin_DeviceReportedPropertiesRecoveryAsync(
        ...
        public async Task Twin_DeviceReportedProperties_AmqpConnectionLossRecovery_Amqp(IotHubClientTransportProtocol protocol, string faultType, string faultReason)
        {
            // Setting up one cancellation token for the complete test flow
            using var cts = new CancellationTokenSource(s_testTimeout);
            await Twin_DeviceReportedPropertiesRecoveryAsync(
