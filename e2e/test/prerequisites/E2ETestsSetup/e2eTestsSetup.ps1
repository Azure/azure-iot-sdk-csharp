...
$dpsGroupX509Intermediate2PfxCertificate = [Convert]::ToBase64String((Get-Content $intermediateCert2PfxPath -AsByteStream));
...
$keyvaultKvps = @{
    ...
    "DPS-GROUPX509-INTERMEDIATE2-PFX-CERTIFICATE" = $dpsGroupX509Intermediate2PfxCertificate;
