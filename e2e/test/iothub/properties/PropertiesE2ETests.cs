...
namespace Microsoft.Azure.Devices.E2ETests.Properties
{
    ...
    public class PropertiesE2ETests : E2EMsTestBase
    {
        ...
        private async Task Properties_ServiceSetsWritablePropertyAndDeviceReceivesEventAndRespondsAsync<T>(Client.TransportType transport, T propValue)
        {
            ...
            bool isWritablePropertyAckPresent = clientProperties.ReportedFromClient.TryGetValue(propName, out IWritablePropertyAcknowledgementValue writablePropertyAck);
            ...
            bool isWritablePropertyAckPresentSpecific = clientProperties.ReportedFromClient.TryGetValue(propName, out NewtonsoftJsonWritablePropertyAcknowledgementValue writablePropertyAckNewtonSoft);
