...
namespace Microsoft.Azure.Devices.E2ETests.Properties
{
    ...
    public class PropertiesWithComponentsE2ETests : E2EMsTestBase
    {
        ...
        public static async Task PropertiesWithComponents_DeviceSetsPropertyAndGetsItBackAsync<T>(DeviceClient deviceClient, string deviceId, T propValue, MsTestLogger logger)
        {
            ...
            bool isPropertyPresent = clientProperties.ReportedFromClient.TryGetValue(ComponentName, propName, out T propFromCollection);
        ...
        private async Task PropertiesWithComponents_ServiceSetsWritablePropertyAndDeviceReceivesEventAndRespondsAsync<T>(Client.TransportType transport, T propValue)
        {
            ...
            bool isWritablePropertyAckPresent = clientProperties.ReportedFromClient.TryGetValue(ComponentName, propName, out IWritablePropertyAcknowledgementValue writablePropertyAck);
            ...
            bool isWritablePropertyAckPresentSpecific = clientProperties.ReportedFromClient.TryGetValue(ComponentName, propName, out NewtonsoftJsonWritablePropertyAcknowledgementValue writablePropertyAckNewtonSoft);
