...
namespace Microsoft.Azure.Devices.E2ETests
{
    public partial class FaultInjectionPoolAmqpTests
    {
        ...
        // TODO: #950 - Link/session faults for message send/ method/ twin operations closes the connection.
        // Ignoring the test as it repeatedly timed out on prod hub. Revert later.
        [Ignore]
        [TestMethod]
        [Timeout(LongRunningTestTimeoutMilliseconds)]
            ...
            string proxyAddress = null)
        {
            ...
            async Task InitAsync(DeviceClient deviceClient, TestDevice testDevice, TestDeviceCallbackHandler testDeviceCallbackHandler)
            {
                await deviceClient.OpenAsync().ConfigureAwait(false);
