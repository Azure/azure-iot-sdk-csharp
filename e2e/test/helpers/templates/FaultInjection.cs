    ...
    public static class FaultInjection
    {
            ...
            Func<Task> cleanupOperation)
        {
            ...
            deviceClient.SetConnectionStatusChangesHandler((status, statusChangeReason) =>
            {
                ...
                VerboseTestLogger.WriteLine($"{nameof(FaultInjection)}.{nameof(ConnectionStatusChangesHandler)}: status={status} statusChangeReason={statusChangeReason} count={connectionStatusChangeCount}");
            });
            ...
            try
            {
                ...
                await ActivateFaultInjectionAsync(transport, faultType, reason, faultDelay, faultDuration, deviceClient).ConfigureAwait(false);
