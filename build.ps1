...
Parameters:
	...
	-skipDigitalTwinTests: Provide this flag if you want to skip all Digital Twin integration tests
...
try
{
    ...
    if ($prtests)
    {
        ...
        if ($skipDigitalTwinTests)
        {
            $testCategory += "&TestCategory!=DigitalTwin"
        }
