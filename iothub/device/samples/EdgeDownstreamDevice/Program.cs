...
namespace Microsoft.Azure.Devices.Client.Samples
{
    class Program
    {
        ...
        // or set it in the launchSettings.json.
        ...
        /// Next attempt to connect to the Edge device and send it DEVICE_MESSAGE_COUNT
        /// number of telemetry data messages.
        ///
        /// Note: Either set the DEVICE_MESSAGE_COUNT environment variable with the number of
        ...
        static void Main()
        {
            ...
            try
            {
                MESSAGE_COUNT = Int32.Parse(Environment.GetEnvironmentVariable("DEVICE_MESSAGE_COUNT"), NumberStyles.None, new CultureInfo("en-US"));
            }
            catch (Exception)
            {
        ...
        {
            string certPath = Environment.GetEnvironmentVariable("EDGE_DEVICE_CA_CERTIFICATE_PATH");
            ...
            {
                Console.WriteLine("EDGE_DEVICE_CA_CERTIFICATE_PATH was not set or null, not installing any CA certificate");
            }
        }
        ...
        /// by environment variable DEVICE_MESSAGE_COUNT.
        /// </summary>
