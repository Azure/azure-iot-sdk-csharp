...
namespace PnpHelpers
{
    public class PnpConvention
    {
        ...
        public static OutgoingMessage CreateMessage(string telemetryName, object telemetryValue, string componentName = default)
        {
            ...
            return CreateMessage(new Dictionary<string, object> { { telemetryName, telemetryValue } }, componentName);
        }
        ...
        /// <see href="https://github.com/Azure/opendigitaltwins-dtdl/blob/master/DTDL/v2/dtdlv2.md#telemetry"/>.</param>
        /// <returns>A plug and play compatible telemetry message, which can be sent to IoT Hub. The caller must dispose this object when finished.</returns>
        public static OutgoingMessage CreateMessage(IDictionary<string, object> telemetryPairs, string componentName = default)
        {
