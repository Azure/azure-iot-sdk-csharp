...
namespace Microsoft.Azure.Devices.Client.Transport.AmqpIot
{
    internal class AmqpIotSession
    {
            ...
            CancellationToken cancellationToken)
        {
            ...
            amqpLinkSettings.AddProperty(AmqpIotConstants.ClientVersion, clientIdentity.ProductInfo.ToString());
            ...
            if (!clientIdentity.AmqpTransportSettings.AuthenticationChain.IsNullOrWhiteSpace())
            {
                amqpLinkSettings.AddProperty(AmqpIotConstants.AuthChain, clientIdentity.AmqpTransportSettings.AuthenticationChain);
            }
            ...
            CancellationToken cancellationToken)
        {
            ...
            uint prefetchCount = clientIdentity.AmqpTransportSettings.PrefetchCount;
        ...
        private static string BuildLinkAddress(IClientIdentity clientIdentity, string deviceTemplate, string moduleTemplate)
        {
            ...
            return clientIdentity.BuildLinkAddress(path).AbsoluteUri;
        }
