...
namespace Microsoft.Azure.Devices.Client
{
    ...
    public class DeviceClient : IDisposable
    {
        ...
        /// <summary>
        /// The object serializer used by the <see cref="Shared.PayloadConvention"/> set in <see cref="ClientOptions.PayloadConvention"/>. If no <see cref="Shared.PayloadConvention"/> is set this will default to <see cref="NewtonsoftJsonPayloadSerializer"/>.
        /// </summary>
