...
namespace Microsoft.Azure.Devices.Client
{
    ...
    public class WritableClientProperty
    {
        ...
        /// </para>
        /// </remarks>
        /// <param name="overrideValue">A custom value for the property update request received.</param>
        /// <param name="statusCode">An acknowledgment code that uses an HTTP status code.</param>
        /// <param name="description">An optional acknowledgment description.</param>
        /// <returns>A writable property update acknowledegement to be reported back to the service.</returns>
        public WritableClientPropertyAcknowledgement CreateAcknowledgement(object overrideValue, int statusCode, string description = default)
        {
            return new WritableClientPropertyAcknowledgement
            {
                ComponentName = ComponentName,
                PropertyName = PropertyName,
                Payload = Convention.PayloadSerializer.CreateWritablePropertyAcknowledgementPayload(overrideValue, statusCode, Version, description),
            };
        }
