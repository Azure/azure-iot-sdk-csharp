...
namespace Microsoft.Azure.Devices.Client
{
    internal class ClientTwinProperties
    {
        ...
        {
            ClientPropertyCollection writablePropertyCollection = ClientPropertyCollection.FromClientPropertiesAsDictionary(Desired, payloadConvention);
            ClientPropertyCollection propertyCollection = ClientPropertyCollection.FromClientPropertiesAsDictionary(Reported, payloadConvention);
