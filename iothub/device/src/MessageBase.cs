...
{
    /// <summary>
    /// The base Message class that is used for interacting with IotHub.
    /// </summary>
    public abstract class MessageBase : IReadOnlyIndicator, IDisposable
    {
        ...
        public MessageBase(Stream stream)
            : this()
        {
            if (stream != null)
            {
        ...
        public MessageBase(byte[] byteArray)
        ...
        internal MessageBase(Stream stream, StreamDisposalResponsibility streamDisposalResponsibility)
            : this(stream)
        {
        ...
        /// </summary>
        internal IDictionary<string, object> SystemProperties { get; set; }
        ...
        /// <summary>
        /// Retrieves the value for the specified key from the SystemProperties dictionary.
        /// </summary>
        /// <typeparam name="T">The type to cast the retrieved value to.</typeparam>
        /// <param name="key">The key whose value is to be retrieved.</param>
        /// <returns>The value for the specified key from the SystemProperties dictionary</returns>
