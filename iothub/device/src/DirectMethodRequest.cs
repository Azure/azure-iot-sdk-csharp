...
namespace Microsoft.Azure.Devices.Client
{
    ...
    {
        internal DirectMethodRequest() { } // @ailn: for serialization only
        ...
        public DirectMethodRequest(string methodName, TimeSpan responseTimeout, TimeSpan connectionTimeout)
        {
        ...
        /// <summary>
        /// Creates an instance of DirectMethodRequest type with Zero timeout
        /// </summary>
        /// <param name="methodName">Method name</param>
        /// <param name="responseTimeout">Method timeout</param>
        /// <exception cref="ArgumentException">If <b>methodName</b> is null or whitespace</exception>
        public DirectMethodRequest(string methodName, TimeSpan responseTimeout)
