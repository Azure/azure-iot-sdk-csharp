    ...
    public abstract class AuthenticationWithTokenRefresh : IAuthenticationMethod, IDisposable
    {
        ...
        public async Task<string> GetTokenAsync(string audience)
        {
            ...
            try
            {
                ...
                _token = await SafeCreateNewToken(audience, _suggestedTimeToLiveSeconds).ConfigureAwait(false);
        ...
        /// </summary>
        /// <param name="audience">The audience that can be accessed with this token.
        /// Tokens granted to devices must be scoped to an individual device; for example, <c>myHub.azure-devices.net/devices/device1</c>.
        /// </param>
        ...
        protected abstract Task<string> SafeCreateNewToken(string audience, int suggestedTimeToLive);
