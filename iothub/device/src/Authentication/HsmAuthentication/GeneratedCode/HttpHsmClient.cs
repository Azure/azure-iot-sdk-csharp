...
#pragma warning disable // Disable all warnings
    ...
    internal partial class HttpHsmClient
    {
        ...
        public async Task<SignResponse> SignAsync(string apiVersion, string name, string genid, SignRequest payload, CancellationToken cancellationToken = default)
        {
            if (name == null)
        ...
        /// <exception cref="SwaggerException">A server side error occurred.</exception>
        /// <param name="cancellationToken">A cancellation token that can be used by other objects or threads to receive notice of cancellation.</param>
        public async Task<EncryptResponse> EncryptAsync(string apiVersion, string name, string genid, EncryptRequest payload, CancellationToken cancellationToken = default)
        {
            if (name == null)
                throw new ArgumentNullException("name");
            ...
            var urlBuilder = new StringBuilder();
            urlBuilder.Append(BaseUrl != null ? BaseUrl.TrimEnd('/') : "").Append("/modules/{name}/genid/{genid}/encrypt?");
            urlBuilder.Replace("{name}", WebUtility.UrlEncode(ConvertToString(name, CultureInfo.InvariantCulture)));
            urlBuilder.Replace("{genid}", WebUtility.UrlEncode(ConvertToString(genid, CultureInfo.InvariantCulture)));
            urlBuilder.Append("api-version=").Append(WebUtility.UrlEncode(ConvertToString(apiVersion, CultureInfo.InvariantCulture))).Append("&");
            urlBuilder.Length--;
            ...
            if (status == "200")
            {
                var responseData = response.Content == null
                    ? null
                    : await response.Content.ReadAsStringAsync().ConfigureAwait(false);
                var result = default(EncryptResponse);
                try
                {
                    result = JsonConvert.DeserializeObject<EncryptResponse>(responseData, _settings.Value);
                    return result;
                }
                catch (Exception ex)
                {
        ...
        /// <exception cref="SwaggerException">A server side error occurred.</exception>
        /// <param name="cancellationToken">A cancellation token that can be used by other objects or threads to receive notice of cancellation.</param>
        public async Task<DecryptResponse> DecryptAsync(string apiVersion, string name, string genid, DecryptRequest payload, CancellationToken cancellationToken = default)
        {
            if (name == null)
                throw new ArgumentNullException("name");
            ...
            var urlBuilder = new StringBuilder();
            urlBuilder.Append(BaseUrl != null ? BaseUrl.TrimEnd('/') : "").Append("/modules/{name}/genid/{genid}/decrypt?");
            urlBuilder.Replace("{name}", WebUtility.UrlEncode(ConvertToString(name, CultureInfo.InvariantCulture)));
            urlBuilder.Replace("{genid}", WebUtility.UrlEncode(ConvertToString(genid, CultureInfo.InvariantCulture)));
            urlBuilder.Append("api-version=").Append(WebUtility.UrlEncode(ConvertToString(apiVersion, CultureInfo.InvariantCulture))).Append("&");
            urlBuilder.Length--;
            ...
            if (status == "200")
            {
                ...
                try
                {
                    return JsonConvert.DeserializeObject<DecryptResponse>(responseData, _settings.Value);
                }
                catch (Exception ex)
                {
                    throw new SwaggerException("Could not deserialize the response body.", (int)response.StatusCode, responseData, headers, ex);
        ...
        /// <exception cref="SwaggerException">A server side error occurred.</exception>
        /// <param name="cancellationToken">A cancellation token that can be used by other objects or threads to receive notice of cancellation.</param>
        public async Task<CertificateResponse> CreateIdentityCertificateAsync(string apiVersion, string name, string genid, CancellationToken cancellationToken = default)
        {
            if (name == null)
                throw new ArgumentNullException("name");
            ...
            var urlBuilder = new StringBuilder();
            urlBuilder.Append(BaseUrl != null ? BaseUrl.TrimEnd('/') : "").Append("/modules/{name}/genid/{genid}/certificate/identity?");
            urlBuilder.Replace("{name}", WebUtility.UrlEncode(ConvertToString(name, CultureInfo.InvariantCulture)));
            urlBuilder.Replace("{genid}", WebUtility.UrlEncode(ConvertToString(genid, CultureInfo.InvariantCulture)));
            urlBuilder.Append("api-version=").Append(WebUtility.UrlEncode(ConvertToString(apiVersion, CultureInfo.InvariantCulture))).Append("&");
            urlBuilder.Length--;
            ...
            if (status == "200")
            {
                ...
                try
                {
                    return JsonConvert.DeserializeObject<CertificateResponse>(responseData, _settings.Value);
                }
                catch (Exception ex)
                {
                    throw new SwaggerException("Could not deserialize the response body.", (int)response.StatusCode, responseData, headers, ex);
        ...
        /// <param name="name">The name of the module to get certificate. (urlencoded)</param>
        /// <param name="genid">The generation identifier for the module as generated by IoT hub.</param>
        /// <param name="certRequest">Parameters for certificate creation.</param>
        /// <returns>Ok</returns>
        /// <exception cref="SwaggerException">A server side error occurred.</exception>
        /// <param name="cancellationToken">A cancellation token that can be used by other objects or threads to receive notice of cancellation.</param>
        public async Task<CertificateResponse> CreateServerCertificateAsync(string apiVersion, string name, string genid, ServerCertificateRequest certRequest, CancellationToken cancellationToken = default)
        {
            if (name == null)
                throw new ArgumentNullException("name");
            ...
            var urlBuilder = new StringBuilder();
            urlBuilder.Append(BaseUrl != null ? BaseUrl.TrimEnd('/') : "").Append("/modules/{name}/genid/{genid}/certificate/server?");
            urlBuilder.Replace("{name}", WebUtility.UrlEncode(ConvertToString(name, CultureInfo.InvariantCulture)));
            urlBuilder.Replace("{genid}", WebUtility.UrlEncode(ConvertToString(genid, CultureInfo.InvariantCulture)));
            urlBuilder.Append("api-version=").Append(WebUtility.UrlEncode(ConvertToString(apiVersion, CultureInfo.InvariantCulture))).Append("&");
            urlBuilder.Length--;
            ...
            var content = new StringContent(JsonConvert.SerializeObject(certRequest, _settings.Value));
            content.Headers.ContentType = MediaTypeHeaderValue.Parse("application/json");
            requestMessage.Content = content;
            requestMessage.Method = new HttpMethod("POST");
            requestMessage.Headers.Accept.Add(new MediaTypeWithQualityHeaderValue("application/json"));

            PrepareRequest(_httpClient, requestMessage, urlBuilder);
            var url = urlBuilder.ToString();
            requestMessage.RequestUri = new Uri(url, UriKind.RelativeOrAbsolute);
            PrepareRequest(_httpClient, requestMessage, url);
        ...
        /// <exception cref="SwaggerException">A server side error occurred.</exception>
        /// <param name="cancellationToken">A cancellation token that can be used by other objects or threads to receive notice of cancellation.</param>
        public async Task<TrustBundleResponse> TrustBundleAsync(string apiVersion, CancellationToken cancellationToken = default)
        {
            if (apiVersion == null)
                throw new ArgumentNullException("apiVersion");
