...
",
        ...
        [TestMethod]
        public async Task ModuleClient_WaitForDeviceStreamRequestAsync()
        {
            var deviceClient = ModuleClient.CreateFromConnectionString(FakeConnectionString);
        ...
        [TestMethod]
        public async Task ModuleClient_AcceptDeviceStreamRequestAsync()
        {
            var deviceClient = ModuleClient.CreateFromConnectionString(FakeConnectionString);
            ...
            _ = deviceClient.AcceptDeviceStreamRequestAsync(request, default);

            await innerHandler.Received().AcceptDeviceStreamRequestAsync(request, default).ConfigureAwait(false);
        }

        [TestMethod]
        public async Task ModuleClient_RejectDeviceStreamRequestAsync()
        {
            var deviceClient = ModuleClient.CreateFromConnectionString(FakeConnectionString);
            ...
            _ = deviceClient.RejectDeviceStreamRequestAsync(request, default);
