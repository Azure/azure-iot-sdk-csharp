...
namespace Microsoft.Azure.Devices.Client.Test.Transport
{
    ...
    public class AmqpTransportHandlerTests
    {
        ...
        public void AmqpTransportHandler_RejectAmqpSettingsChange()
        {
            ...
            {
                ClientConfiguration = new ClientConfiguration(new IotHubConnectionCredentials(TestConnectionString), clientOptions1),
            };
            ...
            try
            {
                ...
                {
                    ClientConfiguration = new ClientConfiguration(new IotHubConnectionCredentials(TestConnectionString), clientOptions2),
                };
        ...
        private AmqpTransportHandler CreateFromConnectionString()
        {
            ...
            {
                ClientConfiguration = new ClientConfiguration(new IotHubConnectionCredentials(TestConnectionString), new IotHubClientOptions(new IotHubClientAmqpSettings())),
            };
