...
namespace Microsoft.Azure.Devices.Client.Tests
{
    [TestClass]
    [TestCategory("Unit")]
    public sealed class IotHubDeviceClientTests
    {
        ...
        public void DeviceAuthenticationWithX509Certificate_EmptyDeviceId_Throws()
        {
            ...
            Action act = () => _ = new ClientAuthenticationWithX509Certificate(cert, "");
        ...
        {
            X509Certificate2 cert = new Mock<X509Certificate2>().Object;
            Action act = () => _ = new ClientAuthenticationWithX509Certificate(cert, null);
            act.Should().Throw<InvalidOperationException>();
        }
        ...
        {
            X509Certificate2 cert = new Mock<X509Certificate2>().Object;
            Action act = () => _ = new ClientAuthenticationWithX509Certificate(cert, "device1", "");
            act.Should().Throw<InvalidOperationException>();
        }
        ...
        public void DeviceAuthenticationWithX509Certificate_ChainCertsAmqpWs_Throws()
        {
            ...
            X509Certificate2 cert = new Mock<X509Certificate2>().Object;
            X509Certificate2Collection certChain = new Mock<X509Certificate2Collection>().Object;
            var authMethod = new ClientAuthenticationWithX509Certificate(cert, certChain, "fakeDeviceId");
            ...
            await deviceClient
                .SetDirectMethodCallbackAsync(
                    (payload) =>
                    {
                        ...
                        bool methodReceived = payload.TryDeserializePayload(out actualMethodBody);
        ...
        public async Task IotHubDeviceClient_OnMethodCalled_BooleanPayload()
        {
            ...
            byte[] expectedPayload = Encoding.UTF8.GetBytes(JsonSerializer.Serialize(true));
            var directMethodRequest = new DirectMethodRequest("TestMethodName", expectedPayload);
            ...
            innerHandler.Verify(
                ...
                Times.AtLeastOnce);
            isMethodHandlerCalled.Should().BeTrue();
            Assert.IsTrue(Enumerable.SequenceEqual(requestPayload, expectedPayload));
        }
        ...
        public async Task IotHubDeviceClient_OnMethodCalled_ListPayload()
        {
            ...
            await deviceClient
                .SetDirectMethodCallbackAsync(
                    ...
                    {
                        isMethodHandlerCalled = true;
                        responseReceivedAsExpected = payload.TryDeserializePayload(out response);
                        return Task.FromResult(_directMethodResponseWithPayload);
                    })
                .ConfigureAwait(false);

            byte[] payload = Encoding.UTF8.GetBytes(JsonSerializer.Serialize(new List<double>() { 1.0, 2.0, 3.0 }));
            var directMethodRequest = new DirectMethodRequest("TestMethodName", payload);
            ...
            Encoding.UTF8.GetBytes(JsonSerializer.Serialize(response)).Should().BeEquivalentTo(payload);
        }
        ...
        public async Task IotHubDeviceClient_OnMethodCalled_MethodRequestHasCustomPayloadResult()
        {
            ...
            var directMethodRequest = new DirectMethodRequest("TestMethodName", JsonSerializer.SerializeToUtf8Bytes(payload))
            {
                RequestId = "1",
            };
        ...
        public async Task IotHubDeviceClient_SetMethodHandlerOverwriteExistingDelegate()
        {
            ...
            Task<DirectMethodResponse> methodCallback(DirectMethodRequest methodRequest)
            {
                ...
                bool methodReceived = methodRequest.TryDeserializePayload(out actualMethodBody);
            ...
            var expectedPayloadDeserialized = new CustomDirectMethodPayload { Grade = "good" };
            var directMethodRequest = new DirectMethodRequest(methodName, JsonSerializer.SerializeToUtf8Bytes(expectedPayloadDeserialized));
            ...
            actualMethodBody.Should().BeEquivalentTo(expectedPayloadDeserialized);
            ...
            Task<DirectMethodResponse> methodCallback2(DirectMethodRequest methodRequest)
            {
                ...
                bool methodReceived = methodRequest.TryDeserializePayload(out actualMethodBody2);
            ...
            directMethodRequest = new DirectMethodRequest(methodName, Encoding.UTF8.GetBytes(JsonSerializer.Serialize(methodBody2)));
        ...
        public async Task MessageIdDefaultSetToNull_SendEventDoesNotSetMessageId()
        {
            ...
            await using var deviceClient = new IotHubDeviceClient(s_fakeConnectionString, options);
        ...
        public async Task MessageIdDefaultNotSet_SendEventBatchDoesNotSetMessageId()
        {
            // arrange
            string messageId = Guid.NewGuid().ToString();
            await using var deviceClient = new IotHubDeviceClient(s_fakeConnectionString, new IotHubClientOptions(new IotHubClientAmqpSettings()));
        ...
        {
            // arrange and act
            Action createDeviceClientAuth = () => _ = new ClientAuthenticationWithSharedAccessKeyRefresh(s_fakeConnectionString, TimeSpan.FromSeconds(-60));
        ...
        {
            // arrange and act
            Action createDeviceClientAuth = () => _ = new ClientAuthenticationWithSharedAccessKeyRefresh(s_fakeConnectionString, sasTokenRenewalBuffer: 200);
        ...
        public async Task IotHubDeviceClient_CreateWithConnectionString_SasTokenTimeToLiveRenewalConfigurable()
        {
            ...
            var auth = new ClientAuthenticationWithSharedAccessKeyRefresh(s_fakeConnectionString, sasTokenTimeToLive, sasTokenRenewalBuffer);
            var options = new IotHubClientOptions(new IotHubClientMqttSettings());
        ...
        private static void IotHubDeviceClient_InitWithNonHttpTransportAndModelId_DoesNotThrow(IotHubClientTransportSettings transportSettings)
        {
            ...
            // act
            Func<Task> act = async () => { await using var deviceClient = new IotHubDeviceClient(s_fakeConnectionString, clientOptions); };
