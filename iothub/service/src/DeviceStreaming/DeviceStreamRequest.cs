...
namespace Microsoft.Azure.Devices
{
    ...
    {
        private static readonly TimeSpan s_defaultDeviceStreamingTimeout = TimeSpan.FromSeconds(60);
        ...
        public DeviceStreamRequest(string streamName)
        {
            ...
            ResponseTimeout = s_defaultDeviceStreamingTimeout;
            ConnectionTimeout = s_defaultDeviceStreamingTimeout;
        }
