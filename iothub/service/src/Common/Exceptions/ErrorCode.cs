...
namespace Microsoft.Azure.Devices.Common.Exceptions
{
    ...
    public enum ErrorCode
    {
        ...
        /// <summary>
        /// Returned by the service if a JSON object provided by this library cannot be parsed, for instance, if the JSON provided for <see cref="TwinClient.UpdateAsync(string, Twin, string, System.Threading.CancellationToken)"/> is invalid.
        /// </summary>
        ...
        /// In order to get the up-to-date ETag for a twin, see <see cref="TwinClient.GetAsync(string, System.Threading.CancellationToken)"/> or <see cref="TwinClient.GetAsync(string, string, System.Threading.CancellationToken)"/>.
        /// </para>
        /// </summary>
