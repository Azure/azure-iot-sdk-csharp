...
namespace Microsoft.Azure.Devices.Common.Exceptions
{
    ...
    /// </summary>
    /// <remarks>
    ///  This exception means the client is not authroized to use the specified IoT Hub. Please review the <see href="https://docs.microsoft.com/azure/iot-hub/iot-hub-troubleshoot-error-401003-iothubunauthorized">401003 IoTHubUnauthorized</see> guide for more information. 
    /// </remarks>
    [Serializable]
