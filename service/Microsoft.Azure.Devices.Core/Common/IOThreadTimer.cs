...
namespace Microsoft.Azure.Devices.Common
{
    ...
    class IOThreadTimer
    {
        ...
        static long GetSystemTimeResolution()
        {
            ...
            if (Interop.UnsafeNativeMethods.GetSystemTimeAdjustment(out dummyAdjustment, out increment, out dummyAdjustmentDisabled) != 0)
            {
        ...
        class WaitableTimer : WaitHandle
        {
            ...
            static class TimerHelper
            {
                ...
                {
                    SafeWaitHandle handle = Interop.UnsafeNativeMethods.CreateWaitableTimer(IntPtr.Zero, false, null);
                    if (handle.IsInvalid)
                    {
                ...
                {
                    if (!Interop.UnsafeNativeMethods.SetWaitableTimer(timer, ref dueTime, 0, IntPtr.Zero, IntPtr.Zero, false))
                    {
