...
#pragma warning restore 1634
        ...
        static void AsyncCompletionWrapperCallback(IAsyncResult result)
        {
            if (result == null)
            {
                new InvalidOperationException(CommonResources.InvalidNullAsyncResult);
            ...
            where TAsyncResult : AsyncResult
        {
            ...
            if (asyncResult == null)
            {
                throw new InvalidOperationException("result " + CommonResources.InvalidAsyncResult);
            }
        ...
        class TransactionSignalScope : SignalGate<IAsyncResult>, IDisposable
        {
            ...
            public TransactionSignalScope(AsyncResult result, Transaction transaction)
            {
                ...
                this.transactionScope = transaction != null ? new TransactionScope(transaction) : null;
            }
            ...
            protected virtual void Dispose(bool disposing)
            {
                if (disposing && !this.disposed)
                {
                    ...
                    try
                    {
                        this.CompleteTransactionScope(ref this.transactionScope);
                    }
            ...
            void CompleteTransactionScope(ref TransactionScope scope)
            {
