...
#else
            //lame workaround
            var a = typeof(Microsoft.Azure.Devices.ApiResources).GetTypeInfo().Assembly;
            //var a = Assembly.GetExecutingAssembly();
            var attribute = (AssemblyFileVersionAttribute)a.GetCustomAttributes(typeof(AssemblyFileVersionAttribute)).ToListSlim()[0];
            return a.GetName().Name + "/" + attribute.Version;
#endif
        }
    }
}
